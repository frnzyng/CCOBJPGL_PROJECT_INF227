...
public class MenuCategory2Controller extends MenuController implements Initializable{
    ...
    static ProductCategory2 product1 = new ProductCategory2("null", 0, 0);
    static ProductCategory2 product2 = new ProductCategory2("null", 0, 0);
    static ProductCategory2 product3 = new ProductCategory2("null", 0, 0);
    static ProductCategory2 product4 = new ProductCategory2("null", 0, 0);
    static ProductCategory2 product5 = new ProductCategory2("null", 0, 0);
    static ProductCategory2 product6 = new ProductCategory2("null", 0, 0);
    static ProductCategory2 product7 = new ProductCategory2("null", 0, 0);
    static ProductCategory2 product8 = new ProductCategory2("null", 0, 0);

    // Method that initializes the name and price of the products upon displaying on the page:
    public void initializeProducts() {

        int productStock1 = ProductCategory2.productStock1;
        int productStock2 = ProductCategory2.productStock2;
        int productStock3 = ProductCategory2.productStock3;
        int productStock4 = ProductCategory2.productStock4;
        int productStock5 = ProductCategory2.productStock5;
        int productStock6 = ProductCategory2.productStock6;
        int productStock7 = ProductCategory2.productStock7;
        int productStock8 = ProductCategory2.productStock8;

        product1.setProductName("Java Chips Shake");
        ...
        product2.setProductName("Strawberry Blast Shake");
        ...
        product3.setProductName("Blueberry Cheesecake Shake");
        product3.setProductPrice(100.00);
        ...
        product4.setProductName("Banana Caramel Shake");
        product4.setProductPrice(80.00);
        ...
        product5.setProductName("Hazelnut Shake");
        ...
        product6.setProductName("Vanilla Special Shake");
        ...
        product7.setProductName("Triple Nut Caramel Shake");
        product7.setProductPrice(100.00);
        ...
        product8.setProductName("Cookies & Cream Shake");
        product8.setProductPrice(80.00);
