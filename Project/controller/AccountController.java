...
public class AccountController implements MainController, Initializable {

    FXMLLoader loader;

    @FXML
    Button homeBtn, menuBtn, cartBtn, ordersBtn, ratingsBtn, aboutUsBtn, accountBtn, orderHistoryBtn, logoutBtn;
    ...
    public void navigationBar(ActionEvent event) throws IOException {
        ...
        else if (sourceButton.equals(ordersBtn)) {
            url = "/view/Orders.fxml";
            css = "/css/Orders.css";
            navigateToPage(event, accountController, url, css);
        } 
        else if (sourceButton.equals(orderHistoryBtn)) {
            url = "/view/OrderHistory.fxml";
            css = "/css/Orders.css";
            navigateToPage(event, orderHistoryController, url, css);
        }
